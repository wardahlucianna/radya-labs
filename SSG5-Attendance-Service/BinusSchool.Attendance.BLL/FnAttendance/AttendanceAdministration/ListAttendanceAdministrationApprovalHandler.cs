...
{
    public class ListAttendanceAdministrationApprovalHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;

        public ListAttendanceAdministrationApprovalHandler(IAttendanceDbContext dbContext)
        {
        ...
        {
            var param = Request.ValidateParams<GetListAttendanceAdministrationApprovalRequest>(nameof(GetListAttendanceAdministrationApprovalRequest.IdAcademicYear),nameof(GetListAttendanceAdministrationApprovalRequest.Semester));
            ...
            if (param.Return == CollectionType.Lov)
                ...
                items = await query
                    .SetPagination(param)
                    .Select(x => new GetListAttendanceAdministrationApprovalResult
                    {
                        Id = x.Id,
