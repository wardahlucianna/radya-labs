...
{
    public class ATD19Notification : FunctionsNotificationHandler, IDisposable
    {
        private IDictionary<string, object> _notificationData;
        private IReadOnlyCollection<ParentAttendanceVm<AbsentSessionAttendanceVm>> _parents;
        private readonly IAttendanceDbContext _dbContext;
        private readonly ILogger<ATD19Notification> _logger;

        public ATD19Notification(
            INotificationManager notificationManager,
            DbContextOptions<AttendanceDbContext> options,
            ILogger<ATD19Notification> logger,
            IConfiguration configuration,
            IDictionary<string, object> notificationData) :
            base("ATD19", notificationManager, configuration, logger)
        {
        ...
        protected override async Task Prepare()
        {
            try
            {
                ...
                var parents = new List<ParentAttendanceVm<AbsentSessionAttendanceVm>>();
                ...
                foreach (var student in students)
                {
                    ...
                    {
                        parents.Add(new ParentAttendanceVm<AbsentSessionAttendanceVm>
                        {
                            IdUser = parent.Parent.Id,
                            EmailAddress = parent.Parent.PersonalEmailAddress,
                            FirstName = parent.Parent.FirstName,
                            LastName = parent.Parent.LastName,
                            StudentAttendance = new AbsentSessionAttendanceVm
                            {
                                ...
                                AttendanceCategory = student.First().AttendanceEntries.FirstOrDefault()?.AttendanceMappingAttendance.Attendance.AttendanceCategory.ToString(),
                                AbsenceCategory = student.First().AttendanceEntries.FirstOrDefault()?.AttendanceMappingAttendance.Attendance.AbsenceCategory?.ToString(),
            ...
            try
            {
                ...
                foreach (var idUser in IdUserRecipients)
                {
                    ...
                    var dataTable = "<tr>" +
                                        ...
                                        "<td>" + dataParent.StudentAttendance.AttendanceCategory + "</td>" +
                                        "<td>" + dataParent.StudentAttendance.AbsenceCategory + "</td>" +
                ...
                _dbContext.Entity<TrSendEmailAttendanceEntry>().AddRange(idGeneratedScheduleLessons.Select(x => new TrSendEmailAttendanceEntry
                {
                    ...
                    Type = AttendanceSendEmailType.Absent
                }));
