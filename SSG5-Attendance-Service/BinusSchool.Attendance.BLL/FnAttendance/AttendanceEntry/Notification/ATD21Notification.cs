...
{
    public class ATD21Notification : FunctionsNotificationHandler, IDisposable
    {
        private IDictionary<string, object> _notificationData;
        private IReadOnlyCollection<ParentAttendanceVm<UpdateSessionAttendanceVm>> _parents;
        private readonly IAttendanceDbContext _dbContext;
        private readonly ILogger<ATD21Notification> _logger;

        public ATD21Notification(
            INotificationManager notificationManager,
            DbContextOptions<AttendanceDbContext> options,
            ILogger<ATD21Notification> logger,
            IConfiguration configuration,
            IDictionary<string, object> notificationData) :
            base("ATD21", notificationManager, configuration, logger)
        {
        ...
        protected override async Task Prepare()
        {
            try
            {
                ...
                var parents = new List<ParentAttendanceVm<UpdateSessionAttendanceVm>>();
                ...
                foreach (var student in students)
                {
                    ...
                    {
                        parents.Add(new ParentAttendanceVm<UpdateSessionAttendanceVm>
                        {
                            IdUser = parent.Parent.Id,
                            EmailAddress = parent.Parent.PersonalEmailAddress,
                            FirstName = parent.Parent.FirstName,
                            LastName = parent.Parent.LastName,
                            StudentAttendance = new UpdateSessionAttendanceVm
                            {
                                OldData = new UpdateSessionAttendanceDataVm
                                {
                                ...
                                NewData = new UpdateSessionAttendanceDataVm
                                {
                                    BinusianId = student.Key.Id,
                                    StudentName = $"{student.Key.FirstName} {student.Key.LastName}",
                                    Grade = student.First().Homeroom.Grade.Description,
            ...
            try
            {
                ...
                foreach (var idUser in IdUserRecipients)
                {
                    ...
                    var dataOld = "<tr>" +
                                        ...
                                        "<td>" + dataParent.StudentAttendance.OldData.ClassId + "</td>" +
                                        "<td>" + dataParent.StudentAttendance.OldData.SessionId + "</td>" +
                    ...
                    var dataNew = "<tr>" +
                                        ...
                                        "<td>" + dataParent.StudentAttendance.NewData.ClassId + "</td>" +
                                        "<td>" + dataParent.StudentAttendance.NewData.SessionId + "</td>" +
