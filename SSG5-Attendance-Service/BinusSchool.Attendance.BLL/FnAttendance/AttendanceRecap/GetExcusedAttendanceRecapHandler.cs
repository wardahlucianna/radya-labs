...
{
    public class GetExcusedAttendanceRecapHandler : FunctionsHttpSingleHandler
    {
        ...
        public GetExcusedAttendanceRecapHandler(IAttendanceDbContext dbContext, IAttendanceRecapService attendanceRecapService, IAttendanceSummaryService attendanceSummaryService)
        {
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            queryUaEa = queryUaEa.Where(e => e.AbsenceCategory == AbsenceCategory.Excused);
