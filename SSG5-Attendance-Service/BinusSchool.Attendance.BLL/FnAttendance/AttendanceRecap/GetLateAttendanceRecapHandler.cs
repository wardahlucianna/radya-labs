...
{
    public class GetLateAttendanceRecapHandler : FunctionsHttpSingleHandler
    {
        ...
        public GetLateAttendanceRecapHandler(IAttendanceDbContext dbContext, IAttendanceRecapService attendanceRecapService, IAttendanceSummaryService attendanceSummaryService)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var queryAttendanceEntry = _dbContext.Entity<TrAttendanceEntryV2>()
                ...
                .Where(e => e.ScheduleLesson.IdAcademicYear == idAcademicYear && e.HomeroomStudent.IdStudent == idStudent &&
                            ...
                            e.ScheduleLesson.IsGenerated == true && e.AttendanceMappingAttendance.Attendance.Code == "LT");
