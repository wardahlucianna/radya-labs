...
{
    public class GetAttendanceRateByStudentHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        public GetAttendanceRateByStudentHandler(IAttendanceDbContext dbContext)
        {
        ...
        protected async override Task<ApiErrorResult<object>> Handler()
        {
            ...
            var result = schedules.GroupBy(x => new { x.IdSubject, x.Subject.Description })
                                  .Select(x => new GetAttendanceRateByStudentResult
                                  {
                                      ...
                                      ClassSession = x.Count(),
                                      Present = x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.AbsenceCategory == null &&  z.AttendanceMappingAttendance.Attendance.AttendanceCategory == AttendanceCategory.Present && (z.AttendanceMappingAttendance.Attendance.Code != "LT" && z.AttendanceMappingAttendance.Attendance.Code != "LTA") && z.AttendanceMappingAttendance.Attendance.AbsenceCategory == null && z.Status == AttendanceEntryStatus.Submitted)),
                                      ...
                                      //                    Math.Abs(x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.Code == "LT" && z.Status == AttendanceEntryStatus.Submitted)) / 4)
                                      //                  : x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.AbsenceCategory == AbsenceCategory.Unexcused && z.Status == AttendanceEntryStatus.Submitted)),
                                      ...
                                      Late = x.Count(y => y.AttendanceEntries.Any(z => (z.AttendanceMappingAttendance.Attendance.Code == "LT" || z.AttendanceMappingAttendance.Attendance.Code == "LTA") && z.Status == AttendanceEntryStatus.Submitted)),
                                      //PresenceRate = isUseDueToLateness
                                      //               ? (double)(x.Count() - x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.AttendanceCategory == AttendanceCategory.Absent && z.Status == AttendanceEntryStatus.Submitted))
                                      //                  - Math.Abs(x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.Code == "LT" && z.Status == AttendanceEntryStatus.Submitted)) / 4)) / x.Count()
                                      //               : (double)(x.Count() - x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.AttendanceCategory == AttendanceCategory.Absent && z.Status == AttendanceEntryStatus.Submitted))) / x.Count(),
                                      PresenceRate = (double)(x.Count() - x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.AttendanceCategory == AttendanceCategory.Absent && z.Status == AttendanceEntryStatus.Submitted))) / x.Count(),
                                      PunctualityRate = (double)(x.Count() - x.Count(y => y.AttendanceEntries.Any(z => (z.AttendanceMappingAttendance.Attendance.Code == "LT" || z.AttendanceMappingAttendance.Attendance.Code == "LTA") && z.Status == AttendanceEntryStatus.Submitted))) / x.Count(),
                                  }).ToList();
