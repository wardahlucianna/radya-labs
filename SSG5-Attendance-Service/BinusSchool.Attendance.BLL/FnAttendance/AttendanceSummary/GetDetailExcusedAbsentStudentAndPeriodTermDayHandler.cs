...
{
    public class GetDetailExcusedAbsentStudentAndPeriodTermDayHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;

        public GetDetailExcusedAbsentStudentAndPeriodTermDayHandler(IAttendanceDbContext dbContext)
        {
