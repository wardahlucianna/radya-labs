...
{
    public class GetSummaryByPeriodHandler : FunctionsHttpSingleHandler
    {
        ...
        public GetSummaryByPeriodHandler(
        ...
        protected async override Task<ApiErrorResult<object>> Handler()
        {
            ...
            foreach (var item in result)
            {
                ...
                item.Submitted = mappingLevel.AbsentTerms == AbsentTerm.Session ?
                                 ...
                                 schedules.Where(x => x.AttendanceEntries.Any(y => y.Status == AttendanceEntryStatus.Submitted)).GroupBy(x => new { x.ScheduleDate, x.IdHomeroom }).Count();
                ...
                item.Unsubmitted = mappingLevel.AbsentTerms == AbsentTerm.Session ?
                                   schedules.Where(x => !x.AttendanceEntries.Any()
            ...
            Logger.LogInformation("period old takes {Seconds}", Math.Round(sw.Elapsed.TotalSeconds, 2));
