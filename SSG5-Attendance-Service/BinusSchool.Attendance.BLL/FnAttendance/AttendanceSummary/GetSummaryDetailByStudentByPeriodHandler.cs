...
{
    public class GetSummaryDetailByStudentByPeriodHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        public GetSummaryDetailByStudentByPeriodHandler(IAttendanceDbContext dbContext)
        {
        ...
        protected async override Task<ApiErrorResult<object>> Handler()
        {
            ...
            result.Data = schedules.GroupBy(x => new { Student = x.GeneratedScheduleStudent.Student, Homeroom = new { x.IdHomeroom, x.HomeroomName } })
                                   .Select(x => new SummaryByStudentResult
                                   {
                                       ...
                                       ClassSession = mapping.AbsentTerms == AbsentTerm.Day ? x.GroupBy(x => x.ScheduleDate).Count() : x.Count(),
                                       ...
                                       ExcusedAbsence = new List<ExcusedAbsence>
                                       {
                                           ...
                                           new ExcusedAbsence{
                                               ...
                                               Count = mapping.AbsentTerms == AbsentTerm.Day ?
                                                       ...
                                                       x.Count(y => y.AttendanceEntries.Any(z => z.AttendanceMappingAttendance.Attendance.ExcusedAbsenceCategory == ExcusedAbsenceCategory.Personal && z.Status == AttendanceEntryStatus.Submitted))
                                           }
                                       ...
                                       AbsenceRate = mapping.AbsentTerms == AbsentTerm.Day ?
                                                     ...
                                                     x.Count(y => y.AttendanceEntries.Any(z => ((z.AttendanceMappingAttendance.Attendance.AttendanceCategory == AttendanceCategory.Present && z.AttendanceMappingAttendance.Attendance.AbsenceCategory == AbsenceCategory.Excused) || z.AttendanceMappingAttendance.Attendance.AttendanceCategory == AttendanceCategory.Absent) && z.Status == AttendanceEntryStatus.Submitted)),
