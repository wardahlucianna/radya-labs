...
{
    public class GetSummaryDetailPendingByLevelByPeriodTermDayHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        private readonly IMachineDateTime _dateTime;

        public GetSummaryDetailPendingByLevelByPeriodTermDayHandler(IAttendanceDbContext dbContext, IMachineDateTime dateTime)
        {
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var columns = new[] { "date", "homeroom", "teacher" };
