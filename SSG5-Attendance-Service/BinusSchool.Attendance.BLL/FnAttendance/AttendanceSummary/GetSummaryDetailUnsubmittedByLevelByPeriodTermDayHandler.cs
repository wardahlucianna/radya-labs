...
{
    public class GetSummaryDetailUnsubmittedByLevelByPeriodTermDayHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        private readonly IMachineDateTime _dateTime;

        public GetSummaryDetailUnsubmittedByLevelByPeriodTermDayHandler(IAttendanceDbContext dbContext, IMachineDateTime dateTime)
        {
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var queryBasic = _dbContext.Entity<TrGeneratedScheduleLesson>()
                                            ...
                                            .Where(x => x.Homeroom.Semester == param.Semester && x.ScheduleDate.Date <= _dateTime.ServerTime.Date)
