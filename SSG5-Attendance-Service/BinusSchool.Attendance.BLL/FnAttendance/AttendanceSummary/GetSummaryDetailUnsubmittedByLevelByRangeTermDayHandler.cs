...
{
    public class GetSummaryDetailUnsubmittedByLevelByRangeTermDayHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        private readonly IMachineDateTime _dateTime;

        public GetSummaryDetailUnsubmittedByLevelByRangeTermDayHandler(
