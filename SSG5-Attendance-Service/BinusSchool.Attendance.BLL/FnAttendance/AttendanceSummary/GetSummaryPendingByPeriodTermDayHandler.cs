...
{
    public class GetSummaryPendingByPeriodTermDayHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        private readonly IMachineDateTime _dateTime;
        public GetSummaryPendingByPeriodTermDayHandler(
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var homeroomTeacher =
                await _dbContext.Entity<MsHomeroomTeacher>()
                .Include(x => x.Staff)
