...
{
    public class GetSummaryPendingByRangeHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        private readonly IMachineDateTime _dateTime;
        public GetSummaryPendingByRangeHandler(
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var query = _dbContext.Entity<TrGeneratedScheduleLesson>()
                                           ...
                                           .GroupBy(x => new { x.ScheduleDate.Date, x.ClassID, x.IdUser, x.TeacherName, x.IdSubject, x.SubjectName, x.IdHomeroom, x.HomeroomName, x.IdSession, x.SessionID });
