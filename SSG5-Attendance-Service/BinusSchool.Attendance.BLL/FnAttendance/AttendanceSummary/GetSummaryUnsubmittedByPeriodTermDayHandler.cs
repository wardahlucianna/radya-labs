...
{
    public class GetSummaryUnsubmittedByPeriodTermDayHandler : FunctionsHttpSingleHandler
    {
        private readonly IAttendanceDbContext _dbContext;
        private readonly IMachineDateTime _dateTime;
        public GetSummaryUnsubmittedByPeriodTermDayHandler(
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var query = _dbContext.Entity<TrGeneratedScheduleLesson>()
                                           ...
                                           .GroupBy(x => new { x.ScheduleDate, x.IdHomeroom, x.HomeroomName });
            ...
            .Select(x => new UnresolvedAttendanceTermDayResult
            {
                ...
                .Where(y => y.ScheduleDate == x.Key.ScheduleDate && y.IdHomeroom == x.Key.IdHomeroom && y.HomeroomName == x.Key.HomeroomName)
                .GroupBy(y => new
                {
                    y.GeneratedScheduleStudent.IdStudent
                })
                .Select(x => x.Key)
                .Count()
            });
