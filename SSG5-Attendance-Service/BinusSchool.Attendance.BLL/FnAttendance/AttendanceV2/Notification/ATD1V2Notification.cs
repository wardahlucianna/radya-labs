...
namespace BinusSchool.Attendance.FnAttendance.AttendanceV2.Notification
{
    ...
    public class ATD1V2Notification : FunctionsNotificationHandler, IDisposable
    {
        private IDictionary<string, object> _notificationData;
        private IReadOnlyCollection<GetNotificationATD1Result> _getNotificationATDs;
        private readonly IAttendanceDbContext _dbContext;
        private readonly ILogger<ATD1V2Notification> _logger;

        public ATD1V2Notification(INotificationManager notificationManager,
            DbContextOptions<AttendanceDbContext> options,
            IConfiguration configuration,
            ILogger<ATD1V2Notification> logger,
        ...
        protected override async Task Prepare()
        {
            try
            {
                ...
                // var objectData = JsonConvert.DeserializeObject<string>((string)data);
                var dataEntry =
                (
