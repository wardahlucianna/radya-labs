...
{
    public class DownloadFileEventAttendanceEntryHandler : FunctionsHttpSingleHandler
    {
        private readonly IStorageManager _storageManager;

        public DownloadFileEventAttendanceEntryHandler(IStorageManager storageManager)
        {
