...
using BinusSchool.Attendance.FnAttendance.File.Validator;
...
namespace BinusSchool.Attendance.FnAttendance.File
{
    public class DeleteFileHandler : FunctionsHttpSingleHandler
    {
        ...
        public CloudStorageAccount GetCloudStorageAccount(ExecutionContext executionContext)
        {
            ...
            var storageAccount = CloudStorageAccount.Parse(Configuration["ConnectionStrings:Attendance:AccountStorage"]);
