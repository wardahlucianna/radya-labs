...
namespace BinusSchool.Attendance.FnAttendance.Models
{
    ...
    public class AttendanceSummarySessionResult : NameValueVm
    {
        public string SessionID { get; set; }
    }

    public class AttendanceSummarySubjectResult : CodeWithIdVm
    {
        public string SubjectID { get; set; }
    }

    public class AttendanceSummaryAttendanceResult : CodeWithIdVm
    {
