...
{
    public static class CheckPositionUserUtil
    {
        /// <summary>
        ...
        public static Dictionary<string, object> PrincipalAndVicePrincipal(IReadOnlyList<OtherPositionResult> positionResults)
        {
            Dictionary<string, object> results = new Dictionary<string, object>();
            if (positionResults.Any(y => y.Id == PositionConstant.Principal)) //check P Or VP
            {
                if (positionResults.Where(y => y.Id == PositionConstant.Principal).ToList() != null && positionResults.Where(y => y.Code == PositionConstant.Principal).Count() > 0)
                {
                    var Principal = positionResults.Where(x => x.Code == PositionConstant.Principal).ToList();
        ...
        public static Dictionary<string, object> LevelHead(IReadOnlyList<OtherPositionResult> positionResults)
        {
            Dictionary<string, object> results = new Dictionary<string, object>();
        ...
        public static Dictionary<string, object> SubjectHeadAndSubjectHeadAsisstant(IReadOnlyList<OtherPositionResult> positionResults)
        {
            Dictionary<string, object> results = new Dictionary<string, object>();
        ...
        public static Dictionary<string, object> HeadOfDepartment(IReadOnlyList<OtherPositionResult> positionResults)
        {
            Dictionary<string, object> results = new Dictionary<string, object>();
