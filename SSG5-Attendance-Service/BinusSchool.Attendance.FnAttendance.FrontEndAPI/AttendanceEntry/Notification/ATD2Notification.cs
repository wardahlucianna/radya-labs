...
{
    public class ATD2Notification : FunctionsNotificationHandler, IDisposable
    {
        private IDictionary<string, object> _notificationData;
        private IReadOnlyCollection<GetNotificationATD2Result> _getNotificationATDs;
        private readonly IAttendanceDbContext _dbContext;
        private readonly ILogger<ATD2Notification> _logger;

        public ATD2Notification(INotificationManager notificationManager,
             DbContextOptions<AttendanceDbContext> options,
             IConfiguration configuration,
             ILogger<ATD2Notification> logger,
            ...
            try
            {
                ...
                var dataEntry =
                    (
                        ...
                        join _staffInput in _dbContext.Entity<MsStaff>() on _scheduleLesson.IdUser equals _staffInput.IdBinusian
                        join _session in _dbContext.Entity<MsSession>() on _scheduleLesson.IdSession equals _session.Id
                        where
                        1 == 1
                        && listIdScheduleLessonEmail.Contains(_attendanceEntry.Id)
