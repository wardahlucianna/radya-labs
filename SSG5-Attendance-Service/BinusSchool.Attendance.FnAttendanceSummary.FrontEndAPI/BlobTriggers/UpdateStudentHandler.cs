...
namespace BinusSchool.Attendance.FnAttendanceSummary.BlobTriggers
{
    public class UpdateStudentHandler
    {
        ...
        public UpdateStudentHandler(IAttendanceDbContext dbContext,
        ...
        [FunctionName(nameof(UpdateStudent))]
        public async Task UpdateStudent([BlobTrigger(_blobPath)] Stream blobStream,
            ...
            CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation("Update student blob trigger runs of {FileName}", name);

            var body = default(SummaryDto)!;
            ...
            try
            {
                ...
                while (await jsonReader.ReadAsync(cancellationToken))
                {
                    ...
                    body = new JsonSerializer().Deserialize<SummaryDto>(jsonReader);
            ...
            var masterAttendances = await _dbContext.Entity<MsAttendanceMappingAttendance>()
                ...
                .Where(e => e.Attendance.IdAcademicYear == body.IdAcademicYear)
                .AsNoTracking()
            ...
            var mappingAttendanceWorkhabits = await _dbContext.Entity<MsMappingAttendanceWorkhabit>()
                ...
                .Where(e => e.MappingAttendance.Level.IdAcademicYear == body.IdAcademicYear)
                .AsNoTracking()
                .ToListAsync(cancellationToken);
            ...
            var blob = container.GetBlockBlobReference($"{name}.json");
