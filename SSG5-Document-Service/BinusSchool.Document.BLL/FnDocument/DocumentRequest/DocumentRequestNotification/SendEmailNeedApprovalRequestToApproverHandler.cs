...
{
    public class SendEmailNeedApprovalRequestToApproverHandler : FunctionsHttpSingleHandler
    {
        // MsNotificationTemplate - DB SCHOOL
        private readonly string _notificationScenario = "DRE04";
        ...
        public SendEmailNeedApprovalRequestToApproverHandler(
        ...
        {
            var param = await Request.ValidateBody<SendEmailNeedApprovalRequestToApproverRequest, SendEmailNeedApprovalRequestToApproverValidator>();

            var result = await SendEmailNeedApprovalRequestToApprover(param);

            return Request.CreateApiResult2(result as object);
        }

        public async Task<SendEmailNeedApprovalRequestToApproverResult> SendEmailNeedApprovalRequestToApprover(SendEmailNeedApprovalRequestToApproverRequest param)
        {
            ...
            emailHtmlTemplate = emailHtmlTemplate
                                ...
                                .Replace("{{RedirectLink}}", hostUrl.Trim() + "/DocumentRequest/DocumentRequestApproval")
            ...
            var result = new SendEmailNeedApprovalRequestToApproverResult();
