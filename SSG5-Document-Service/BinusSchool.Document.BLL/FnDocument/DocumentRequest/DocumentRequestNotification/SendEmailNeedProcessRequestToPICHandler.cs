...
{
    public class SendEmailNeedProcessRequestToPICHandler : FunctionsHttpSingleHandler
    {
        // MsNotificationTemplate - DB SCHOOL
        private readonly string _notificationScenario = "DRE06";
        ...
        public SendEmailNeedProcessRequestToPICHandler(
        ...
        {
            var param = await Request.ValidateBody<SendEmailNeedProcessRequestToPICRequest, SendEmailNeedProcessRequestToPICValidator>();

            var result = await SendEmailNeedProcessRequestToPIC(param);

            return Request.CreateApiResult2(result as object);
        }

        public async Task<SendEmailNeedProcessRequestToPICResult> SendEmailNeedProcessRequestToPIC(SendEmailNeedProcessRequestToPICRequest param)
        {
            ...
            var result = new SendEmailNeedProcessRequestToPICResult();
