...
{
    public class SendEmailDataUpdateRequestToStaffValidator : AbstractValidator<SendEmailDataUpdateRequestToStaffRequest>
    {
        public SendEmailDataUpdateRequestToStaffValidator()
        {
