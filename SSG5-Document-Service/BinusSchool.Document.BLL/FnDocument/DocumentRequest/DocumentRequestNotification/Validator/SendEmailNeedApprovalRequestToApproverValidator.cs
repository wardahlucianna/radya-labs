...
{
    public class SendEmailNeedApprovalRequestToApproverValidator : AbstractValidator<SendEmailNeedApprovalRequestToApproverRequest>
    {
        public SendEmailNeedApprovalRequestToApproverValidator()
        {
