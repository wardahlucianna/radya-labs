...
{
    public class BrailleExpLevelEndPoint
    {
        private const string _route = "staff/braille-exp-level";
        private const string _tag = "LtTable";
        private readonly BrailleExpLevelHandler _handler;
        public BrailleExpLevelEndPoint(BrailleExpLevelHandler brailleExpLevelHandler)
        {
            _handler = brailleExpLevelHandler;
        }

        [FunctionName(nameof(BrailleExpLevelEndPoint.GetBrailleExpLevels))]
        [OpenApiOperation(tags: _tag, Summary = "Get Braille Exp Level List")]
        ...
        public Task<IActionResult> GetBrailleExpLevels(
