...
{
    public class EmployeeStatusEndpoint
    {
        private const string _route = "staff/employee-status";
        private const string _tag = "LtTable";
        private readonly EmployeeStatusHandler _handler;
        public EmployeeStatusEndpoint(EmployeeStatusHandler employeeStatusHandler)
        {
            _handler = employeeStatusHandler;
        }

        [FunctionName(nameof(EmployeeStatusEndpoint.GetEmployeeStatus))]
        [OpenApiOperation(tags: _tag, Summary = "Get Braille Employee Status List")]
        ...
        public Task<IActionResult> GetEmployeeStatus(
