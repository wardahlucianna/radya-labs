...
{
    public class IsyaratLevelEndpoint
    {
        private const string _route = "staff/isyarat-level";
        private const string _tag = "LtTable";
        private readonly IsyaratLevelHandler _handler;
        public IsyaratLevelEndpoint(IsyaratLevelHandler isyaratLevelHandler)
        {
            _handler = isyaratLevelHandler;
        }

        [FunctionName(nameof(IsyaratLevelEndpoint.GetIsyaratLevels))]
        [OpenApiOperation(tags: _tag, Summary = "Get Isyarat Level List")]
        ...
        public Task<IActionResult> GetIsyaratLevels(
