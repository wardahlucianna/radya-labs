...
{
    public class KITASStatusEndpoint
    {
        private const string _route = "staff/kitas-status";
        private const string _tag = "LtTable";
        private readonly KITASStatusHandler _handler;
        public KITASStatusEndpoint(KITASStatusHandler kitasStatusHandler)
        {
            _handler = kitasStatusHandler;
        }

        [FunctionName(nameof(KITASStatusEndpoint.GetKITASStatus))]
        [OpenApiOperation(tags: _tag, Summary = "Get KITAS Status List")]
        ...
        public Task<IActionResult> GetKITASStatus(
