...
{
    public class LabSkillsLevelEndPoint
    {
        private const string _route = "staff/lab-skills-level";
        private const string _tag = "LtTable";
        private readonly LabSkillsLevelHandler _handler;
        public LabSkillsLevelEndPoint(LabSkillsLevelHandler labSkillsLevelHandler)
        {
            _handler = labSkillsLevelHandler;
        }

        [FunctionName(nameof(LabSkillsLevelEndPoint.GetLabSkillsLevels))]
        [OpenApiOperation(tags: _tag, Summary = "Get Lab Skills Level List")]
        ...
        public Task<IActionResult> GetLabSkillsLevels(
