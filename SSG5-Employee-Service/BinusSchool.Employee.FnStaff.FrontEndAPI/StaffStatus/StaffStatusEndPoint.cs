...
{
    public class StaffStatusEndPoint
    {
        private const string _route = "staff/staff-status";
        private const string _tag = "LtTable";
        private readonly StaffStatusHandler _handler;
        public StaffStatusEndPoint(StaffStatusHandler staffStatusHandler)
        {
            _handler = staffStatusHandler;
        }

        [FunctionName(nameof(StaffStatusEndPoint.GetStaffStatus))]
        [OpenApiOperation(tags: _tag, Summary = "Get Staff Status List")]
        ...
        public Task<IActionResult> GetStaffStatus(
