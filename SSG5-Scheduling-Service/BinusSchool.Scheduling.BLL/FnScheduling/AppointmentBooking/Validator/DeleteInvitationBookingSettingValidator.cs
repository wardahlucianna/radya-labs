...
{
    public class DeleteInvitationBookingSettingValidator : AbstractValidator<DeleteInvitationBookingSettingRequest>
    {
        public DeleteInvitationBookingSettingValidator()
        {
