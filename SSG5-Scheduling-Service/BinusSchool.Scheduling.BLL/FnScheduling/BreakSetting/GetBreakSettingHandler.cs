...
{
    public class GetBreakSettingHandler : FunctionsHttpSingleHandler
    {
        private readonly ISchedulingDbContext _dbContext;
        private readonly IMachineDateTime _dateTime;

        public GetBreakSettingHandler(ISchedulingDbContext BreakSettingDbContext, IMachineDateTime dateTime)
        {
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var GetSchedule = await _dbContext.Entity<TrGeneratedScheduleLesson>()
                    .Where(e => e.IdUser == param.IdUserTeacher && e.ScheduleDate.Date == param.DateCalender.Date && e.IsGenerated)
                    .Select(e => new
                    {
