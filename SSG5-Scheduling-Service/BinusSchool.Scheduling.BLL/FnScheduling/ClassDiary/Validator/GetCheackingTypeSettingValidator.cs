...
{
    public class GetCheackingTypeSettingValidator : AbstractValidator<GetCheackingTypeSettingRequest>
    {
        public GetCheackingTypeSettingValidator()
        {
            ...
            RuleFor(x => x.HomeroomId).NotEmpty().WithMessage("Homeroom cannot empty");
            RuleFor(x => x.LessoinId).NotEmpty().WithMessage("ClassId cannot empty");
