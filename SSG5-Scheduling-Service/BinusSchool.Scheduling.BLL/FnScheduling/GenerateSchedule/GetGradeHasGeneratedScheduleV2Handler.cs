...
{
    public class GetGradeHasGeneratedScheduleV2Handler : FunctionsHttpSingleHandler
    {
        private readonly ISchedulingDbContext _dbContext;

        public GetGradeHasGeneratedScheduleV2Handler(ISchedulingDbContext dbContext)
        {
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var predicate = PredicateBuilder.Create<MsScheduleLesson>(x => param.IdSchool.Any(y => y == x.Grade.Level.AcademicYear.IdSchool));
