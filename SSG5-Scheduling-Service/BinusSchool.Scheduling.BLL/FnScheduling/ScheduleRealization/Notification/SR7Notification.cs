...
{
    public class SR7Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<SR7Notification> _logger;
        ...
        public SR7Notification(INotificationManager notificationManager, IRolePosition rolePosition, IConfiguration configuration, ILogger<SR7Notification> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) :
           base("SR7", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SendEmailNotification()
        {
            try
            {
                ...
                foreach (var idUser in IdUserRecipients)
                {
                    ...
                    {
                        { "FirstSubstituteTeacher",userEmail.DisplayName },
                        { "Date",_EmailScheduleRealization.Date.Value.ToString("dd MMMM yyyy") },
                        ...
                        { "EntryStatus", _EmailScheduleRealization.Status},
        ...
        protected override async Task SaveNotification(IEnumerable<string> idUserRecipients, bool isBlast)
        {
            try
            {
                ...
                foreach (var idUser in IdUserRecipients)
                {
                    ...
                    {
                        GeneratedContent = $"Class Subtitution. There is a class substitution. Please check your email for the details.";
                    }
                    else
                    {
