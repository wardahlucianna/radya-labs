...
{
    public class SR9Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<SR9Notification> _logger;
        ...
        public SR9Notification(INotificationManager notificationManager, IRolePosition rolePosition, IConfiguration configuration, ILogger<SR9Notification> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) :
           base("SR9", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SendEmailNotification()
        {
            try
            {
                ...
                foreach (var idUser in IdUserRecipients)
                {
                    ...
                    {
                        { "ToTeacherName",userEmail.DisplayName },
