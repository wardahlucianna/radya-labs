...
namespace BinusSchool.Scheduling.FnSchedule.ScheduleRealization
{
    ...
    public class SendEmailForCancelClassHandler : FunctionsHttpSingleHandler
    {
        private readonly ISchedulingDbContext _dbContext;

        public SendEmailForCancelClassHandler(ISchedulingDbContext dbContext)
        {
        ...
        {
            var body = await Request.ValidateBody<SendEmailForCancelClassRequest, SendEmailForCancelClassValidator>();
