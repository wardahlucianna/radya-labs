...
{
    public class EM11Notification : FunctionsNotificationHandler
    {
        ...
        public EM11Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM11", notificationManager, configuration, logger)
        {
