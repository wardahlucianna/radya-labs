...
{
    public class EM5Notification : FunctionsNotificationHandler
    {
        ...
        public EM5Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM5", notificationManager, configuration, logger)
        {
