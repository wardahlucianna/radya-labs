...
{
    public class UpdateSchoolEventValidator : AbstractValidator<UpdateSchoolEventRequest>
    {
        public UpdateSchoolEventValidator()
        {
            RuleFor(x => x.IdEvent).NotEmpty().WithMessage("Event code cannot empty");
            ...
            // RuleFor(x => x.EventLavel).NotEmpty().WithMessage("School Event Level cannot empty");
