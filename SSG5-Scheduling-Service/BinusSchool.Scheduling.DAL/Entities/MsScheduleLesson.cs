...
{
    public class MsScheduleLesson : AuditEntity, ISchedulingEntity
    {
        ...
        public string IdGeneratedScheduleGrade { get; set; }
    ...
    internal class MsScheduleLessonConfiguration : AuditEntityConfiguration<MsScheduleLesson>
    {
        public override void Configure(EntityTypeBuilder<MsScheduleLesson> builder)
        {
          ...
          .HasForeignKey(fk => fk.IdGeneratedScheduleGrade)
          .HasConstraintName("FK_MsScheduleLesson_TrGeneratedScheduleGrade")
          .OnDelete(DeleteBehavior.NoAction)
          .IsRequired()
          ;
