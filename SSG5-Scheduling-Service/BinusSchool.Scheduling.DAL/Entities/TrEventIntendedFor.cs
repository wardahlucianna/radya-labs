...
{
    public class TrEventIntendedFor : AuditEntity, ISchedulingEntity
    {
        ...
        public virtual ICollection<TrEventIntendedForDepartment> EventIntendedForDepartments { get; set; }
        ...
        public virtual ICollection<TrEventIntendedForGradeParent> EventIntendedForGradeParents { get; set; }
    }
