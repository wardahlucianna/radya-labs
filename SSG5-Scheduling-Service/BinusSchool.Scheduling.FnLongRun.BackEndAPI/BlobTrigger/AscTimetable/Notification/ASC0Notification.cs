...
{
    public class ASC0Notification : FunctionsNotificationHandler
    {
        ...
        public ASC0Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<ASC0Notification> logger) : 
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            var errorMessage = new EmailData
            {
                ...
                Subject = "An Error Occured, Upload/Reupload Asc Timetable Failed",
                Body = 
