...
{
    public class ASC2Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;

        private readonly ISchedulingDbContext _dbContext;
        
        public ASC2Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<ASC2Notification> logger, ISchedulingDbContext dbContext) : 
            base("ASC2", notificationManager, configuration, logger)
        {
