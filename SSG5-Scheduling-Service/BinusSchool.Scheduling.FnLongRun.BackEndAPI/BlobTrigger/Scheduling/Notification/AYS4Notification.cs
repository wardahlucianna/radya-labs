...
{
    public class AYS4Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;

        private readonly ISchedulingDbContext _dbContext;
        
        public AYS4Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<AYS4Notification> logger, ISchedulingDbContext dbContext) : 
            base("AYS4", notificationManager, configuration, logger)
        {
