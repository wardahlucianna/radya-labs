...
{
    public class AYS5Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;

        private readonly ISchedulingDbContext _dbContext;
        
        public AYS5Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<AYS5Notification> logger, ISchedulingDbContext dbContext) : 
            base("AYS5", notificationManager, configuration, logger)
        {
