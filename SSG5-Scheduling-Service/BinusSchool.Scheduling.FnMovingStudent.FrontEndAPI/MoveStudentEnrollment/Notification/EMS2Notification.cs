...
{
    public class EMS2Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<EMS2Notification> _logger;
        private readonly ISchedulingDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public EMS2Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<EMS2Notification> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) :
           base("EMS2", notificationManager, configuration, logger)
        {
            _dbContext = dbContext;
            _configuration = configuration;
            _logger = logger;

            //PushNotificationData["action"] = "EMS_DELETE";
        }
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            foreach (var itemUser in userEmails)
            {
                ...
                _notificationData["Subject"] = EmailMoveStudentEnrollment.oldSubject;
                _notificationData["SubjectLevel"] = EmailMoveStudentEnrollment.oldSubjectLevel;
