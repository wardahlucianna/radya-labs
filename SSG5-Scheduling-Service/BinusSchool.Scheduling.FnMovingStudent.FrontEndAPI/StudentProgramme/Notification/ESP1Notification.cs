...
{
    public class ESP1Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<ESP1Notification> _logger;
        private readonly ISchedulingDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public ESP1Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<ESP1Notification> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) :
           base("ESP1", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            foreach (var itemUser in userEmails)
            {
                ...
                _notificationData["NewProgramme"] = emailStudentProgramme.newProgramme;
                _notificationData["OldProgramme"] = emailStudentProgramme.oldProgramme;
