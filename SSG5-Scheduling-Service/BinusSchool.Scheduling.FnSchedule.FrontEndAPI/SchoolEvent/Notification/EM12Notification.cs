...
{
    public class EM12Notification : FunctionsNotificationHandler
    {
        ...
        public EM12Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM12", notificationManager, configuration, logger)
        {
