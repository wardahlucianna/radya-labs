...
{
    public class EM13Notification : FunctionsNotificationHandler
    {
        ...
        public EM13Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM13", notificationManager, configuration, logger)
        {
