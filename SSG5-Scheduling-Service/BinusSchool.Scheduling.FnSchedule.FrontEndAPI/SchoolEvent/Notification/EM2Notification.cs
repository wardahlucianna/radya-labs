...
{
    public class EM2Notification : FunctionsNotificationHandler
    {
        ...
        public EM2Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM2", notificationManager, configuration, logger)
        {
