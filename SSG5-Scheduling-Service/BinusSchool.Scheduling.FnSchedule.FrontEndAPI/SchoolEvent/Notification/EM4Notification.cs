...
{
    public class EM4Notification : FunctionsNotificationHandler
    {
        ...
        public EM4Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM4", notificationManager, configuration, logger)
        {
