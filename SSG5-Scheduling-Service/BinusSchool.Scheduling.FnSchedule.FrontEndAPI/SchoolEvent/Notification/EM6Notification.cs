...
{
    public class EM6Notification : FunctionsNotificationHandler
    {
        ...
        public EM6Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM6", notificationManager, configuration, logger)
        {
