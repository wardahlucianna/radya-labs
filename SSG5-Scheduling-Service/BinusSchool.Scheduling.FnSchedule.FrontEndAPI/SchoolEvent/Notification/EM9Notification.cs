...
{
    public class EM9Notification : FunctionsNotificationHandler
    {
        ...
        public EM9Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration, 
            ILogger<FunctionsNotificationHandler> logger, ISchedulingDbContext dbContext, IDictionary<string, object> notificationData) : base("EM9", notificationManager, configuration, logger)
        {
