using System;
using BinusSchool.Scheduling.FnSync;
...
namespace BinusSchool.Scheduling.FnSync
{
    public class FnSyncStartup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services
                ...
                .AddPersistence<ISchedulingDbContext, SchedulingDbContext>(configuration, int.MaxValue);
        ...
        public override void ConfigureAppConfiguration(IFunctionsConfigurationBuilder builder)
        {
            ...
            builder.ConfigurationBuilder.AddFunctionsConfiguration(nameof(Scheduling), envName, hostContext.ApplicationRootPath, "SyncRefTable:*");
