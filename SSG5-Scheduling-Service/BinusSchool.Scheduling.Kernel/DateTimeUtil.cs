...
public static class DateTimeUtil
{
    ...
    public static bool IsIntersect(DateTime sourceStart, DateTime sourceEnd, DateTime compareStart, DateTime compareEnd)
    {
    ...
    public static IEnumerable<(DateTime start, DateTime end)> ToEachDay(DateTime from, DateTime until)
    {
