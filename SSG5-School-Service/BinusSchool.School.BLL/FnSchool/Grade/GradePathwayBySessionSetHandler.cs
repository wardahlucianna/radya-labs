...
{
    public class GradePathwayBySessionSetHandler : FunctionsHttpSingleHandler
    {
        private readonly ISchoolDbContext _dbContext;
        public GradePathwayBySessionSetHandler(ISchoolDbContext schoolDbContext)
        {
        ...
        {
            var param = Request.ValidateParams<GradePathwayBySessionSetIdForXmlRequest>(nameof(GradePathwayBySessionSetIdForXmlRequest.IdSessionset));
            var gradeByGradePathway = await _dbContext.Entity<MsGradePathway>()
                                              ...
                                              .Where(p => p.Sessions.Any(x => x.IdSessionSet == param.IdSessionset) && p.Grade.Level.IdAcademicYear==param.IdAcademicyear)
