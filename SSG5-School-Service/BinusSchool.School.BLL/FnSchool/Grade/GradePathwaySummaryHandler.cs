...
{
    public class GradePathwaySummaryHandler : FunctionsHttpSingleHandler
    {
        private readonly ISchoolDbContext _dbContext;
        public GradePathwaySummaryHandler(ISchoolDbContext schoolDbContext)
        {
        ...
        {
            var param = Request.ValidateParams<GetGradePathwaySummaryRequest>(new string[] { nameof(GetGradePathwaySummaryRequest.IdGrade) });
