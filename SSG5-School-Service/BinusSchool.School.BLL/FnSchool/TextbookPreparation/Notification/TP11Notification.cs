...
{
    public class TP11Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<TP11Notification> _logger;
        private readonly ISchoolDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public TP11Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<TP11Notification> logger, ISchoolDbContext dbContext, IDictionary<string, object> notificationData) :
           base("TP11", notificationManager, configuration, logger)
        {
            _dbContext = dbContext;
            _configuration = configuration;
            _logger = logger;

            PushNotificationData["action"] = "TP_UPDATE_PIC";
        }
        ...
        protected override async Task SendPushNotification()
        {
            ...
            _notificationData["TextbookPICName"] = EmailTextbook.NameUser;
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            _notificationData["Data"] = EmailTextbook.Textbooks.ToList();
            _notificationData["TextbookPICName"] = EmailTextbook.NameUser;
