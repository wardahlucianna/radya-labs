...
{
    public class TP6Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<TP6Notification> _logger;
        private readonly ISchoolDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public TP6Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<TP6Notification> logger, ISchoolDbContext dbContext, IDictionary<string, object> notificationData) :
           base("TP6", notificationManager, configuration, logger)
        {
            _dbContext = dbContext;
            _configuration = configuration;
            _logger = logger;

            PushNotificationData["action"] = "TP_ENTRY";
        }
        ...
        protected override async Task SendPushNotification()
        {
            ...
            _notificationData["Staff"] = EmailTextbook.NameCreated;
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            foreach(var ItemUser in GetUser)
            {
                ...
                _notificationData["Approver1"] = ItemUser.EmailAddress.Name;
