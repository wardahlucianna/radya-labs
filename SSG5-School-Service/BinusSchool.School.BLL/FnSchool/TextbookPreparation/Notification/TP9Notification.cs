...
{
    public class TP9Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<TP9Notification> _logger;
        private readonly ISchoolDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public TP9Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<TP9Notification> logger, ISchoolDbContext dbContext, IDictionary<string, object> notificationData) :
           base("TP9", notificationManager, configuration, logger)
        {
            _dbContext = dbContext;
            _configuration = configuration;
            _logger = logger;

            PushNotificationData["action"] = "TP_APPROVED_PIC";
        }
        ...
        protected override Task Prepare()
        {
            try
            {
                var UrlBase = $"{_configuration.GetSection("ClientApp:Web:Host").Get<string>()}/textbook/detail";
        ...
        protected override async Task SendPushNotification()
        {
            ...
            _notificationData["TextbookEntry"] = EmailTextbook.NameCreated;
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            {
                _notificationData["TextbookPIC"] = item.EmailAddress.Name;
