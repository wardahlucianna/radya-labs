...
namespace BinusSchool.School.FnSchool.SurveySummary.Notification
{
    public class ESS1Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<ESS1Notification> _logger;
        private readonly ISchoolDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public ESS1Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<ESS1Notification> logger, ISchoolDbContext dbContext, IDictionary<string, object> notificationData) :
           base("ESS1", notificationManager, configuration, logger)
        {
