...
{
    public class TP3Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<TP3Notification> _logger;
        private readonly ISchoolDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public TP3Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<TP3Notification> logger, ISchoolDbContext dbContext, IDictionary<string, object> notificationData) :
           base("TP3", notificationManager, configuration, logger)
        {
            _dbContext = dbContext;
            _configuration = configuration;
            _logger = logger;

            PushNotificationData["action"] = "TP_USER_DATE";
        }
        ...
        protected override async Task SendPushNotification()
        {
            ...
            _notificationData["OpeningDateOld"] = EmailTextbookUserPeriod.DateStartOld;
            _notificationData["CloseDateOld"] = EmailTextbookUserPeriod.DateEndOld;
            _notificationData["OpeningDateNew"] = EmailTextbookUserPeriod.DateStartNew;
            _notificationData["CloseDateNew"] = EmailTextbookUserPeriod.DateEndNew;
