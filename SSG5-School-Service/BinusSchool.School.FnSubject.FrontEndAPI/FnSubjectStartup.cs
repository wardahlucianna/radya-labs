...
using BinusSchool.School.FnSubject;
using Microsoft.Azure.Functions.Extensions.DependencyInjection;

[assembly: FunctionsStartup(typeof(FnSubjectStartup))]
namespace BinusSchool.School.FnSubject
{
    public class FnSubjectStartup : FunctionsStartup
    {
        public FnSubjectStartup()
        {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services
                .AddFunctionsService<FnSubjectStartup, ISchoolDbContext>(configuration, false, _consumeApiDomains)
