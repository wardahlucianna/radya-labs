...
{
    public class GetListSubstitutionReportResult
    {
        ...
        public List<DataListTeacher> DataTeachers {get; set; }
        public List<DataListSubtituteTeacher> DataSubtituteTeachers {get; set; }
    ...
    public class DataListTeacher : ItemValueVm
    {

    }

    public class DataListSubtituteTeacher : ItemValueVm
    {
