...
{
    /// <summary>
    /// Entity base to hold auditrail information with Id as Primary Key
    /// </summary>
    public abstract class AuditEntity : UniqueEntity, IAuditable
    {
    ...
    public class AuditEntityConfiguration<T> : UniqueEntityConfiguration<T> where T : AuditEntity, IEntity
    {
