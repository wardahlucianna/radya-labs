...
{
    public class GetCounselorGradeByCounsellorHandler : FunctionsHttpSingleHandler
    {
        private readonly IStudentDbContext _dbContext;
        private readonly IRolePosition _serviceRolePosition;

        public GetCounselorGradeByCounsellorHandler(IStudentDbContext dbContext, IRolePosition serviceRolePosition)
        {
        ...
        {
            var param = Request.ValidateParams<GetCounselorGradeByCounsellorRequest>();
