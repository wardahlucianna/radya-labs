...
{
    public class UpdateParentAddressInformationHandler : FunctionsHttpSingleHandler
    {
        ...
        public UpdateParentAddressInformationHandler(IStudentDbContext dbContext, IConfiguration configuration
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            try
            {
                var body = await Request.ValidateBody<UpdateParentAddressInformationRequest, UpdateParentAddressInformationValidator>();

                var newParentInfoUpdateIdList = new List<string>();

                var newBody = new SetParentAddressInformation
                {
