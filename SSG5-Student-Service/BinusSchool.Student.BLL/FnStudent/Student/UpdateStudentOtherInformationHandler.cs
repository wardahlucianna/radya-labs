...
{
    public class UpdateStudentOtherInformationHandler : FunctionsHttpSingleHandler
    {
        ...
        public UpdateStudentOtherInformationHandler(IStudentDbContext dbContext, IConfiguration configuration
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            try
            {
                var body = await Request.ValidateBody<UpdateStudentOtherInformationRequest, UpdateStudentOtherInformationValidator>();

                var newParentInfoUpdateIdList = new List<string>();

                var newBody = new SetStudentOtherInformation
                {
