...
{
    public class UpdateStudentPrevSchoolInfoHandler : FunctionsHttpSingleHandler
    {
        ...
        public UpdateStudentPrevSchoolInfoHandler(IStudentDbContext dbContext, IConfiguration configuration
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            try
            {
                ...
                {
                    var getdata = await _dbContext.Entity<MsStudentPrevSchoolInfo>().Where(p => p.IdStudent == body.IdUser).FirstOrDefaultAsync();
                    if (getdata is null)
                    ...
                    if (body.IdApprovalStatus == 1)
                    {
                        ...
                        _dbContext.Entity<MsStudentPrevSchoolInfo>().Update(getdata);
                    }
                }
