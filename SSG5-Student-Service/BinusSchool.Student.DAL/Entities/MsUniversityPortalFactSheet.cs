...
{
    public class MsUniversityPortalFactSheet : AuditEntity, IStudentEntity
    {
    ...
    internal class MsUniversityPortalFactSheetConfiguration : AuditEntityConfiguration<MsUniversityPortalFactSheet>
    {
        public override void Configure(EntityTypeBuilder<MsUniversityPortalFactSheet> builder)
        {
            ...
            builder.HasOne(x => x.UniversityPortal)
             .WithMany(x => x.UniversityPortalFactSheet)
             .HasForeignKey(fk => fk.IdUniversityPortal)
             .HasConstraintName("FK_MsUniversityPortalFactSheet_MsUniversityPortal")
