...
namespace BinusSchool.Student.FnGuidanceCounseling.File
{
    public class FileEndpoint
    {
        private const string _route = "guidance-counseling/file";
        private const string _tag = "Guidance Counseling File";
