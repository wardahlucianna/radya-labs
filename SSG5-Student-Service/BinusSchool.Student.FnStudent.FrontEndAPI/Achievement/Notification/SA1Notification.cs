...
{
    public class SA1Notification : FunctionsNotificationHandler
    {
        ...
        private readonly ILogger<SA1Notification> _logger;

        public SA1Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<SA1Notification> logger, IStudentDbContext dbContext, IDictionary<string, object> notificationData) :
            base("SA1", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SaveNotification(IEnumerable<string> idUserRecipients, bool isBlast)
        {
            try
            {
                ...
                foreach (var idUser in IdUserRecipients)
                {
                    ...
                    {
                        GeneratedContent = $"{_studentAchievementResult.StudentName} has added achievement data. Please do approval on the Achievement Approval Menu.";
                    }
                    else
                    {
