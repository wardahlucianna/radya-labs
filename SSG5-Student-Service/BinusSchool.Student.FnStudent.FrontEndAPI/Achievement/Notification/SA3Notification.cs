...
{
    public class SA3Notification : FunctionsNotificationHandler
    {
        ...
        private readonly ILogger<SA3Notification> _logger;
        public SA3Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<SA3Notification> logger, IStudentDbContext dbContext, IDictionary<string, object> notificationData) :
            base("SA3", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SaveNotification(IEnumerable<string> idUserRecipients, bool isBlast)
        {
            try
            {
                ...
                foreach (var idUser in IdUserRecipients)
                {
                    ...
                    {
                        GeneratedContent = $"{_studentAchievementResult.VerifyingTeacher} has approved your achievement. Please check on My Achievement menu.";
                    }
                    else
                    {
