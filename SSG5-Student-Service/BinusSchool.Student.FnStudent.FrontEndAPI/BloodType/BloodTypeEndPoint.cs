...
{
    public class BloodTypeEndPoint
    {
        private const string _route = "student/blood-type";
        private const string _tag = "Literal table";

        private readonly BloodTypeHandler _bloodTypeHandler;
        public BloodTypeEndPoint(BloodTypeHandler bloodTypeHandler)
        {
            _bloodTypeHandler = bloodTypeHandler;
        }

        [FunctionName(nameof(BloodTypeEndPoint.GetBloodTypes))]
        [OpenApiOperation(tags: _tag, Summary = "Get Blood Type List")]
        ...
        public Task<IActionResult> GetBloodTypes(
           [HttpTrigger(AuthorizationLevel.Function, "get", Route = _route)] HttpRequest req,
           CancellationToken cancellationToken)
        {
            return _bloodTypeHandler.Execute(req, cancellationToken);
        }
    }
}
