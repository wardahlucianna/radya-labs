...
{
    public class CAS4Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<CAS4Notification> _logger;
        private readonly IStudentDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public CAS4Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<CAS4Notification> logger, IStudentDbContext dbContext, IDictionary<string, object> notificationData) :
           base("CAS4", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SendPushNotification()
        {
            ...
            _notificationData["StudentName"] = GetComment.StudentName;
            PushNotificationData["id"] = GetComment.Id;
            PushNotificationData["action"] = GetComment.UserRole == RoleConstant.Student
                                                ? "CAS_COMMENT_STD"
                                                : GetComment.UserRole == RoleConstant.Staff
                                                    ? "CAS_COMMENT"
                                                    : "CAS_COMMENT_SPV";
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            _notificationData["Name"] = User.EmailAddress.Name;
            _notificationData["StudentName"] = GetComment.StudentName;
            _notificationData["ExperienceName"] = GetComment.ExperienceName;
            _notificationData["CommentName"] = GetComment.CommentName;
            _notificationData["Comment"] = GetComment.Comment;
