...
{
    public class CAS5Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<CAS5Notification> _logger;
        private readonly IStudentDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public CAS5Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<CAS5Notification> logger, IStudentDbContext dbContext, IDictionary<string, object> notificationData) :
           base("CAS5", notificationManager, configuration, logger)
        {
        ...
        protected override Task Prepare()
        {
            ...
            {
                //belum update link
                var UrlBase = $"{_configuration.GetSection("ClientApp:Web:Host").Get<string>()}/creativityactivityservice/student";
        ...
        protected override async Task SendPushNotification()
        {
            ...
            _notificationData["CasAdvisorName"] = GetExperienceStudent.CasAdvisorName;
            PushNotificationData["id"] = GetExperienceStudent.Id;
            PushNotificationData["action"] = "CAS_OVERALL";
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            _notificationData["AcademicYear"] = GetExperienceStudent.AcademicYear;
            _notificationData["BinusianId"] = GetExperienceStudent.IdStudent;
            _notificationData["CasAdvisorName"] = GetExperienceStudent.CasAdvisorName;
            _notificationData["OverallStatus"] = GetExperienceStudent.OverallStatus;
            _notificationData["Link"] = $"{_notificationData["UrlBase"]}?idAY={GetExperienceStudent.IdAcademicYear}";
