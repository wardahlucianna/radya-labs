...
{
    public class CAS8Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<CAS8Notification> _logger;
        private readonly IStudentDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public CAS8Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<CAS8Notification> logger, IStudentDbContext dbContext, IDictionary<string, object> notificationData) :
           base("CAS8", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SendPushNotification()
        {
            ...
            _notificationData["DateLatestUpdate"] = GetExperienceEmail.LastUpdate;
            PushNotificationData["id"] = GetExperienceEmail.Id;
            PushNotificationData["action"] = "CAS_DETAIL_STUDENT";
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            _notificationData["Link"] = $"{_notificationData["UrlBase"]}?idExperience={GetExperienceEmail.Id}";
