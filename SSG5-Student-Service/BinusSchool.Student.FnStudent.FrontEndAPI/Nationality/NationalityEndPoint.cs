...
namespace BinusSchool.Student.FnStudent.Nationality
{
    ...
    {
        private const string _route = "student/nationality";
        private const string _tag = "Literal table";

        private readonly NationalityHandler _nationalityHandler;
        public NationalityEndPoint(NationalityHandler nationalityHandler)
        {
            _nationalityHandler = nationalityHandler;
        }

        [FunctionName(nameof(NationalityEndPoint.GetNationalities))]
        [OpenApiOperation(tags: _tag, Summary = "Get Nationality List")]
        ...
        {
            return _nationalityHandler.Execute(req, cancellationToken);
        }
    }
}
