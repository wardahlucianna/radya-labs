...
{
    public class NationalityCountryEndPoint
    {
        private const string _route = "student/nationality-country";
        private const string _tag = "Nationality Country";
        private readonly NationalityCountryHandler _nationalityCountryHandler;
        public NationalityCountryEndPoint(NationalityCountryHandler nationalityCountryHandler)
        {
            _nationalityCountryHandler = nationalityCountryHandler;
        }

        [FunctionName(nameof(NationalityCountryEndPoint.GetNationalitiesCountry))]
        [OpenApiOperation(tags: _tag, Summary = "Get Nationality Country List")]
        [OpenApiSecurity("function_key", SecuritySchemeType.ApiKey, Name = "x-functions-key", In = OpenApiSecurityLocationType.Header)]
        [OpenApiSecurity("authorization", SecuritySchemeType.ApiKey, Name = "authorization", In = OpenApiSecurityLocationType.Header)]
        [OpenApiParameter(nameof(CollectionRequest.Ids), In = ParameterLocation.Query)]
        ...
        [OpenApiResponseWithBody(HttpStatusCode.OK, "application/json", typeof(GetNationalityCountryResult))]
        public Task<IActionResult> GetNationalitiesCountry(
           [HttpTrigger(AuthorizationLevel.Function, "get", Route = _route)] HttpRequest req,
           CancellationToken cancellationToken)
        {
            return _nationalityCountryHandler.Execute(req, cancellationToken);
        }
    }
}
