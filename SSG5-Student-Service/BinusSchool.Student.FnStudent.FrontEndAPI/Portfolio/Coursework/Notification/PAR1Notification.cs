...
{
    public class PAR1Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<PAR1Notification> _logger;
        private readonly IStudentDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public PAR1Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<PAR1Notification> logger, IStudentDbContext dbContext, IDictionary<string, object> notificationData) :
        base("PAR1", notificationManager, configuration, logger)
        {
        ...
        protected override async Task SendEmailNotification()
        {
            ...
            foreach (var receipment in IdUserRecipients)
            {
                ...
                {
                    Subject = $"{GetDataCourseworkAnecdotalEmail.TeacherName} posted coursework on {GetDataCourseworkAnecdotalEmail.Date}",
