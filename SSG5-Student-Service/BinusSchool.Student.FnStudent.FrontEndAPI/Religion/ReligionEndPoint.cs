...
{
    public class ReligionEndPoint
    {
        private const string _route = "student/religion";
        private const string _tag = "Literal table";

        private readonly ReligionHandler _religionHandler;
        public ReligionEndPoint(ReligionHandler religionHandler)
        {
            _religionHandler = religionHandler;
        }

        [FunctionName(nameof(ReligionEndPoint.GetReligions))]
        [OpenApiOperation(tags: _tag, Summary = "Get Religion List")]
        ...
        public Task<IActionResult> GetReligions(
           [HttpTrigger(AuthorizationLevel.Function, "get", Route = _route)] HttpRequest req,
           CancellationToken cancellationToken)
        {
            return _religionHandler.Execute(req, cancellationToken);
        }
    }
}
