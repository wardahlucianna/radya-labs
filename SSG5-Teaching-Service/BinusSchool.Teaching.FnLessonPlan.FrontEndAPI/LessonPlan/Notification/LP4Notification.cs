...
{
    public class LP4Notification : FunctionsNotificationHandler
    {
        private const string _idScenario = "LP4";
        ...
        public LP4Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<LP4Notification> logger, ITeachingDbContext dbContext) :
        base("LP4", notificationManager, configuration, logger)
        {
