...
{
    public class LP5Notification : FunctionsNotificationHandler
    {
        private const string _idScenario = "LP5";
        ...
        public LP5Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<LP4Notification> logger, ITeachingDbContext dbContext) :
        base("LP5", notificationManager, configuration, logger)
        {
