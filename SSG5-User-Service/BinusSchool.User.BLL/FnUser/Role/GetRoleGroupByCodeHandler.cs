...
{
    public class GetRoleGroupByCodeHandler : FunctionsHttpSingleHandler
    {
        private readonly IUserDbContext _dbContext;

        public GetRoleGroupByCodeHandler(IUserDbContext dbContext)
        {
        ...
        protected override async Task<ApiErrorResult<object>> Handler()
        {
            ...
            var query = await _dbContext.Entity<LtRoleGroup>()
                .Where(x => param.Ids.Contains(x.Code))
