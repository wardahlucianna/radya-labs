...
using BinusSchool.User.FnAuth;
using Microsoft.Azure.Functions.Extensions.DependencyInjection;

[assembly: FunctionsStartup(typeof(FnAuthStartup))]
namespace BinusSchool.User.FnAuth
{
    public class FnAuthStartup : FunctionsStartup
    {
        public FnAuthStartup()
        {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services
                .AddFunctionsService<FnAuthStartup, IUserDbContext>(configuration, false)
