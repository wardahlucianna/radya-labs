...
{
    public class FD1Notification : FunctionsNotificationHandler
    {
        ...
        public FD1Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration,
            ILogger<FunctionsNotificationHandler> logger, IUserDbContext dbContext, IDictionary<string, object> notificationData) : base("FD1", notificationManager, configuration, logger)
        {
        ...
        {
            var url = _configuration.GetSection("WebApp:baseUrl").Get<string>();
        ...
        protected async override Task SendPushNotification()
        {
            ...
            PushNotificationData["action"] = "MS_FEEDBACK";
