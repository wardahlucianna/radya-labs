...
{
    public class FD2Notification : FunctionsNotificationHandler
    {
        ...
        public FD2Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration,
            ILogger<FunctionsNotificationHandler> logger, IUserDbContext dbContext, IDictionary<string, object> notificationData) : base("FD2", notificationManager, configuration, logger)
        {
