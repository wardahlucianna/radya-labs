...
{
    public class EHN3Notification : FunctionsNotificationHandler
    {
        private IDictionary<string, object> _notificationData;
        private readonly ILogger<EHN3Notification> _logger;
        private readonly IUserDbContext _dbContext;
        private readonly IConfiguration _configuration;

        public EHN3Notification(INotificationManager notificationManager, IConfiguration configuration, ILogger<EHN3Notification> logger, IUserDbContext dbContext, IDictionary<string, object> notificationData) :
           base("EHN3", notificationManager, configuration, logger)
        {
