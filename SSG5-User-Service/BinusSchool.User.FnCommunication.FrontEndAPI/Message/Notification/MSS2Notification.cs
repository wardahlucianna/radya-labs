...
{
    public class MSS2Notification : FunctionsNotificationHandler
    {
        ...
        public MSS2Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration,
            ILogger<FunctionsNotificationHandler> logger, IUserDbContext dbContext, IDictionary<string, object> notificationData) : base("MSS2", notificationManager, configuration, logger)
        {
        ...
        protected async override Task Prepare()
        {
            ...
            GeneratedContent = HttpUtility.HtmlDecode(GeneratedContent);
        }
        ...
        protected async override Task SendPushNotification()
        {
            ...
            PushNotificationData["action"] = "MS_INFORMATION";
