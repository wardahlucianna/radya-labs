...
{
    public class MSS5Notification : FunctionsNotificationHandler
    {
        ...
        public MSS5Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration,
            ILogger<FunctionsNotificationHandler> logger, IUserDbContext dbContext, IDictionary<string, object> notificationData) : base("MSS5", notificationManager, configuration, logger)
        {
