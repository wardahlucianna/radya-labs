...
{
    public class MSS8Notification : FunctionsNotificationHandler
    {
        ...
        public MSS8Notification(string idScenario, INotificationManager notificationManager, IConfiguration configuration,
            ILogger<FunctionsNotificationHandler> logger, IUserDbContext dbContext, IDictionary<string, object> notificationData) : base("MSS8", notificationManager, configuration, logger)
        {
